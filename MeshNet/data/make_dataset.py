...
def make_folder(df, type_='train'):
    ...
    for idx, row in tqdm(df.iterrows()):
        ...
        copyfile(f"/home/nhtlong/pmkhoi/shrec21/retrieval/MeshNet/datasets/dataset{args.task}/objects/train/{obj_id}.obj", class_path)
...
ROOT_DIR = f'/home/nhtlong/pmkhoi/shrec21/retrieval/MeshNet/datasets/dataset{args.task}/folds/fold_{args.fold}'
if not os.path.exists(ROOT_DIR):
    os.mkdir(ROOT_DIR)
train_df = pd.read_csv(f'/home/nhtlong/pmkhoi/shrec21/retrieval/MeshNet/datasets/dataset{args.task}/annotations/{args.fold}_train.csv')
val_df = pd.read_csv(f'/home/nhtlong/pmkhoi/shrec21/retrieval/MeshNet/datasets/dataset{args.task}/annotations/{args.fold}_val.csv')
